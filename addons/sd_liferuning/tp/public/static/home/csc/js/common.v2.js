...
var _pl_file_uploader = {
    ...
    complete: null,
    dataType: 'json',
    url: 'https://'+window.location.host+'/addons/sd_liferuning/tp/index.php/user/upload'
};
$(document).ready(function () {
    ...
    function uploader_init() {
        _pl_file_uploader.uploader = new plupload.Uploader({
            ...
            url: 'https://'+window.location.host+'/addons/zjhj_mall/core/web/index.php?r=upload%2Ffile', //服务器端的上传页面地址
        });
...
$.upload_file = function (args) {
    ...
    _pl_file_uploader.url = args.url || 'https://'+window.location.host+'/addons/sd_liferuning/tp/index.php/user/upload';               //上传图片路径
