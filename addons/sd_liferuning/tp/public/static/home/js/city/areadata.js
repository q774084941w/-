...
function svae_City() {
    ...
    var cityspan = $('.data-result span') 			  //获取的 span值
    citys = $(".city").text($(".area-duoxuan").val())	      //获取所有城市
	for (var i = 0; i < cityspan.length; i++) {		  //循环城市的 data值
		citydata += $(cityspan[i]).attr('data-code')+','
