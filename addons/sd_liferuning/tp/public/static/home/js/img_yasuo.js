	...
	function UpLoad(e){
		...
		if(/image\/\w+/.test(fileType)) {
			...
			fileReader.onload = function(event) {
				...
				var asd = "<section class='up-section fl 0'><span class='up-span'></span><img class='close-upimg' src='../../static/home/img/a7.png'  onclick='closeimg($(this))'><img class='up-img' src="+this.result+"  /></section>"
...
//					//var finalURL = c.toDataURL(img,0.2);
//					var finalURL = c.toDataURL(img,1.0);
