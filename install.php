...
function remote_install() {
	...
	curl_setopt($ch, CURLOPT_POSTFIELDS, https_build_query($pars, '', '&'));
			...
			<div class="panel-body">
				<div class="form-group">
					...
					<div class="col-sm-10">
						...
						<label class="radio-inline">
							<a target="_blank" href="httpss://jq.qq.com/?_wv=1027&k=5ddBXif"><img border="0" src="//pub.idqqimg.com/wpa/images/group.png" alt="公众号运营交流" title="公众号运营交流"></a>
						</label>
...
function get_store_module() {
	...
	$response = ihttps_request(APP_STORE_API, array('controller' => 'store', 'action' => 'api', 'do' => 'module'));
...
function get_store_theme() {
	load()->func('communication');
	$response = ihttps_request(APP_STORE_API, array('controller' => 'store', 'action' => 'api', 'do' => 'theme'));
	$response = json_decode($response['content'], true);
